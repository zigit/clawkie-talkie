...
export function decideForwardToLivePeer(
  ...
  if (kind === 'offer') {
    // No renegotiation in this app: initiators never expect a remote
    // offer, and a non-initiator only takes the very first offer.
  ...
  // renegotiate / transceiver / unknown — not used on these short-lived
  // peers; dropping is safer than handing them to RTCPeerConnection.
